 ...
 * @author  wflores
 */
public class LabelExtendedPage extends javax.swing.JPanel implements IExtendedPage
{    
    private LabelColumnHandler typeHandler;
    
    public LabelExtendedPage() {
        initComponents();
    }
    
    public Column.TypeHandler getTypeHandler() { return typeHandler; }
    public void setTypeHandler(Column.TypeHandler typeHandler) {
        this.typeHandler = new LabelColumnHandler(); 
    } 

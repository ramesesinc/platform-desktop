...
public class ArrangeForwardCommand extends Command{
    
    public ArrangeForwardCommand(Canvas canvas){
        super("draw_arrange_forward", canvas);
    }

    @Override
    public KeyStroke getKeyStroke() {
        return KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP, InputEvent.CTRL_DOWN_MASK, true);
    }
